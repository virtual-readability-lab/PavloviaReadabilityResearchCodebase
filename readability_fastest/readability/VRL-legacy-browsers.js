...
function donotuseSAFARIRoutineBegin(snapshot) {
  return async function () {
    ...
    donotuseSAFARIComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function normalizeFontTrialsLoopBegin(normalizeFontTrialsLoopScheduler, snapshot) {
  return async function() {
    ...
    normalizeFontTrials.forEach(function() {
...
function stimulus_listLoopBegin(stimulus_listLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    stimulus_list.forEach(function() {
...
function passage_trialsLoopBegin(passage_trialsLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    passage_trials.forEach(function() {
...
function question_trialsLoopBegin(question_trialsLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    question_trials.forEach(function() {
...
function minisurvey_trialsLoopBegin(minisurvey_trialsLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    minisurvey_trials.forEach(function() {
...
function waitForNormalizationRoutineBegin(snapshot) {
  return async function () {
    ...
    waitForNormalizationComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function setBlockParametersRoutineBegin(snapshot) {
  return async function () {
    ...
    setBlockParametersComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function setTrialParametersRoutineBegin(snapshot) {
  return async function () {
    ...
    setTrialParametersComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function instructions_passageRoutineBegin(snapshot) {
  return async function () {
    ...
    instructions_passageComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function displayPassaagesRoutineBegin(snapshot) {
  return async function () {
    ...
    displayPassaagesComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function displayQuestionsRoutineBegin(snapshot) {
  return async function () {
    ...
    displayQuestionsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function displayMiniSurveyRoutineBegin(snapshot) {
  return async function () {
    ...
    displayMiniSurveyComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function findFastestRoutineBegin(snapshot) {
  return async function () {
    ...
    averageFontWpm = []
    for (var i = 0; i < blockFontCount; i++) {
      var wpmDictionary = getFastestFont[blockFonts[i]];
      var fontWpm = wpmDictionary[0];
      var fontDivisior = wpmDictionary[1];
      var fontAverageWpm = fontWpm / fontDivisior;
    ...
    index = averageFontWpm.indexOf(maxWPM);
    
    fastestFont = blockFonts[index];
    fastestFontLabel = blockFontLabels[index];
    ...
    findFastestComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function writeDataToFileRoutineBegin(snapshot) {
  return async function () {
    ...
    writeDataToFileComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function finalInstructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    finalInstructionsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
